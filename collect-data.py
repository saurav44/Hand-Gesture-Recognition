...
if not os.path.exists("/home/saurav/ml/Mini_Project/data"):
    os.makedirs("data")
    ...
    os.makedirs("data/train/no_gestures")
    ...
    os.makedirs("data/test/no_gestures")
...
while True:
    ...
    cv2.putText(frame, "No Gestures : "+str(count['no_gestures']), (10, 240), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    ...
    if interrupt & 0xFF == ord('6'):
        cv2.imwrite(directory+'no_gestures/'+str(count['no_gestures'])+'.jpg', roi)
